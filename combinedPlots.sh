...
if [[ "$OSTYPE" == "msys" ]]; then
    ...
    ./cmake-build-release/Bsc_ITP_MP 6 $start $end 10000 -1 $noX silent # 10000
    ./cmake-build-release/Bsc_ITP_MP 8 $start $end 5000 -1 $noX silent # 10000
    ./cmake-build-release/Bsc_ITP_MP 10 $start $end 500 -1 $noX silent # 5000
