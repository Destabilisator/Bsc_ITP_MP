...
./$build/$prgm 18 $start $end 48 $h -1 $noX silent && echo ""
...
./$build/$prgm 20 $start $end 24 $h -1 $noX silent && echo ""
./$build/$prgm 22 $start $end 24 $h -1 $noX silent && echo ""
./$build/$prgm 24 $start $end 12 $h -1 $noX silent && echo ""
./$build/$prgm 26 $start $end 12 $h -1 $noX silent && echo ""
