...
def plot_delta_E(N):
    ...
    subfig1.set_ylabel(r'$\Delta E$  in $J_2$', fontsize = 25)
    subfig1.set_title(r'Anregungsenergieren $\Delta E = E_1 - E_0$, h = ' + linesh, fontsize = 25)
    subfig1.axhline(0, color = "grey")
    subfig1.legend(loc = 'best' ,frameon = False, fontsize = 20)
    plt.savefig("results/" + N + "/delta_E_h" + linesh + ".png")
...
def plot_specific_heat_T_const(N):
    ...
    #subfig1.axhline(0, color = "grey")
    subfig1.legend(loc = 'best' ,frameon = False, fontsize = 20)
    plt.savefig("results/" + N + "/C_beta" + linesBeta + "_h" + linesh + ".png")
...
def plot_specific_heat_J_const(N):
    ...
    file = open("results/" + N + "/data/data_specific_heat_J_const_QT.txt", 'r')
    lines = file.readlines()
    ...
    subfig1.axhline(0, color = "grey")
    subfig1.legend(loc = 'best' ,frameon = False, fontsize = 20)
    plt.savefig("results/" + N + "/C_J" + linesJ + "_h" + linesh + ".png")
...
def plot_susceptibility_T_const(N):
    ...
    #subfig1.axhline(0, color = "grey")
    subfig1.legend(loc = 'best' ,frameon = False, fontsize = 20)
    plt.savefig("results/" + N + "/X_beta" + linesBeta + ".png")
...
def plot_susceptibility_J_const(N):
    ...
    # file = open("results/" + N + "/data/momentum_susceptibility_J_const.txt", 'r')
    # lines = file.readlines()
    # linesJ = lines[0][len("J1/J2: "):-1]
    # lbl = "N = " + N
    # X = []
    ...
    # file = open("results/" + N + "/data/data_susceptibility_J_const_QT_MB.txt", 'r')
    # lines = file.readlines()
    # linesJ = lines[0][len("J1/J2: "):-1]
    # lbl = "N = " + N
    # X = []
    ...
    file = open("results/" + N + "/data/data_susceptibility_J_const_QT.txt", 'r')
    lines = file.readlines()
    linesJ = lines[0][len("J1/J2: "):-1]
    lbl = "N = " + N
    X = []
    ...
    # file = open("results/" + N + "/data/data_susceptibility_J_const_MB.txt", 'r')
    # lines = file.readlines()
    # linesJ = lines[0][len("J1/J2: "):-1]
    # lbl = "N = " + N
    # X = []
    ...
    # file = open("results/" + N + "/data/spininversion_susceptibility_J_const.txt", 'r')
    # lines = file.readlines()
    # linesJ = lines[0][len("J1/J2 = "):-1]
    # lbl = "N = " + N
    # X = []
    ...
    subfig1.axhline(0, color = "grey")
    subfig1.legend(loc = 'best' ,frameon = False, fontsize = 20)
    plt.savefig("results/" + N + "/X_J" + linesJ + ".png")
...
def plot_k_dispersion_J_const(N):
    ...
    subfig1.axhline(0, color = "grey")
    subfig1.legend(loc = 'best' ,frameon = False, fontsize = 20)
    plt.savefig("results/" + N + "/energy_dispersion_J" + linesJ + ".png")
...
def plot_spin_gap(N):
    ...
    subfig1.axhline(0, color = "grey")
    subfig1.legend(loc = 'best' ,frameon = False, fontsize = 20)
    plt.savefig("results/" + N + "/spin_gap.png")
