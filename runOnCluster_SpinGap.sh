...
if [[ "$regime" == "low" ]]; then
	...
	./$build/$prgm 6 $start $end 50 $h 3 $noX silent && echo "" # 10000
    # $pth plotting/deleteData.py 8 SG
	./$build/$prgm 8 $start $end 50 $h 3 $noX silent && echo "" # 10000
    # $pth plotting/deleteData.py 10 SG
	./$build/$prgm 10 $start $end 50 $h 3 $noX silent && echo "" # 5000
    # $pth plotting/deleteData.py 12 SG
	./$build/$prgm 12 $start $end 50 $h 3 $noX silent && echo "" # 1000
